...
import { Alert, Box, Button, FormControl, FormHelperText, InputLabel, OutlinedInput, Snackbar } from '@mui/material';
    ...
    return (
        <>
            ...
            >
                <Alert
                    onClose={() => setOpenSnackbar(false)}
                    severity={snackmode === 'success' ? 'success' : 'error'}
                    sx={{ width: '100%' }}
                >
                    {snackbarMessage}
                </Alert>
                ...
                onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                    try {
                        ...
                        if (!response.data.error) {
                            ...
                            setTimeout(() => {
                                navigate(`pages/check-mail/check-mail3/${values.email}`, { replace: true });
                            }, 2000);
                        } else {
