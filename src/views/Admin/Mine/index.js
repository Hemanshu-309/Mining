...
const MineList = () => {
    ...
    const handleDelete = async () => {
        try {
            ...
            console.log(response);
            if (!response.data.error) {
                setSnackbarMessage('Mine Inactivate Successfully');
                setOpenSnackbar(true);
    ...
    return (
        <>
            ...
            <MainCard title="Mines" content={false}>
                <CardContent>
                    <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                            ...
                            <MineAdd open={open} handleCloseDialog={handleCloseDialog} setOpen={setOpen} getMine={getMine} />
                        </Grid>
                    </Grid>
                </CardContent>
