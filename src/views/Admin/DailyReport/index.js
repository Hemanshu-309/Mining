    ...
    return (
        <TableHead>
            <TableRow>
                ...
                {numselected <= 0 && (
                    <TableCell sortDirection={false} align="justify" size="medium">
                        <Typography variant="subtitle1" sx={{ color: theme.palette.mode === 'dark' ? 'grey.600' : 'grey.900', px: 5 }}>
                            Action
                        </Typography>
                    </TableCell>
                )}
                                    ...
                                    .map((row, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left" sx={{ pr: 3, display: 'flex', alignItems: 'center' }} width="100px">
                                                    {isEditing ? (
                                                    ...
                                                    |
                                                    <IconButton size="large" align="left" onClick={() => handleReportbyId(row.id)}>
                                                        <VisibilityIcon />
                                                    </IconButton>
                                                </TableCell>
                                            </TableRow>
